...
class _SessionsTabState extends State<SessionsTab> {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        tempStart != null ? _formatTimeOfDay(tempStart!) : '--:--',
                                        style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.bold,
                                          color: tempStart != null ? AppColors.primary : AppColors.textSecondary,
                                        ),
                                      ),
                                      Icon(
                                        Icons.access_time,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        tempEnd != null ? _formatTimeOfDay(tempEnd!) : '--:--',
                                        style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.bold,
                                          color: tempEnd != null ? AppColors.primary : AppColors.textSecondary,
                                        ),
                                      ),
                                      Icon(
                                        Icons.access_time,
    ...
    return WaterDropletsBackground(
      child: Scaffold(
        ...
        body: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Search & Filter Header (with Filter Button beside Search)
            Container(
              color: Colors.white,
                  ...
                  Row(
                    children: [
                      ...
                      if (!_isCalendarView) ...[
                        ...
                        // Filter Icon Button (Opens Unified Date & Timings Modal)
                        GestureDetector(
                  ...
                  children: [
                    ...
                    Text(
                      _showOnlyBookmarked
                          ...
                          : _selectedDate != null || _customStartTime != null || _customEndTime != null
                              ? 'No sessions match the selected date & timings filter'
                    ...
                    if (_showOnlyBookmarked) ...[
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Try resetting or adjusting the date or timings filter above.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 12,
                          color: AppColors.textLight,
      ...
      children: [
        ...
        Expanded(
          child: daySessions.isEmpty
              ...
              : ListView.builder(
                  physics: const AlwaysScrollableScrollPhysics(parent: BouncingScrollPhysics()),
                  padding: EdgeInsets.fromLTRB(14, 6, 16, MediaQuery.of(context).padding.bottom + 36),
  ...
  // ==========================================
  // Calendar Timeline Item (Time Outside Card)
  // ==========================================
  ...
  Widget _buildCalendarTimelineItem(
    ...
    return IntrinsicHeight(
      child: Row(
        ...
        children: [
          // 1. Time Column on Left (Vertically Centered with continuous timeline)
          SizedBox(
            width: 52,
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
